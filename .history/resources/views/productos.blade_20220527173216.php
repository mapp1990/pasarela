...
<html lang="es">
  ...
  <body class="body">
    ...
    <div class="d-md-flex flex-md-equal w-100 my-md-3 pl-md-3">
        <div class="bg-dark mr-md-6 pt-6 px-6 pt-md-6 px-md-6 text-center text-white overflow-hidden">
            <div class="my-3 py-3">
        ...
        <div class="bg-light mr-md-6 pt-6 px-6 pt-md-6 px-md-6 text-center overflow-hidden">
            <div class="my-3 p-3">
            <h2 class="display-5">Another headline</h2>
            <p class="lead">And an even wittier subheading.</p>
            </div>
