...
@section('content')
    ...
    <div class="flex-md-equal  col-12">
        @foreach($products as $producto)
            <div class="bg-dark col-6 col-md text-center text-white overflow-hidden" style="margin-top: 20px">
                ...
                <div class="bg-light shadow-sm mx-auto" style="width: 80%; border-radius: 21px 21px 0 0;">
                    ...
                    <form method="POST" action="{{route(verificacion_informacion)}}">
                        @csrf
                        ...
                        <button onclick="" type="button" class="btn btn-info" style="margin-top: 30px; margin-bottom: 30px;">Comprar</button>
                    </form>
                </div>
            </div>
        @endforeach
